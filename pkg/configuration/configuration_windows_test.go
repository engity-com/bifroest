...
func TestConfiguration_UnmarshalYAML(t *testing.T) {
	...
	require.Equal(t, `C:\ProgramData\Engity\Bifroest\recordings`, DefaultAuditlogRecordingDirectory)
    ...
    type: local`,
			expected: Configuration{
				...
				Ssh: Ssh{
					...
					GracefulShutdownTimeout:         DefaultSshGracefulShutdownTimeout,
					HandshakeTimeout:                DefaultSshHandshakeTimeout,
					SessionRequestTimeout:           DefaultSshSessionRequestTimeout,
					MaxAuthTries:                    DefaultSshMaxAuthTries,
					MaxConnections:                  DefaultSshMaxConnections,
					MaxStartupsStart:                DefaultSshMaxStartupsStart,
					MaxStartupsRate:                 DefaultSshMaxStartupsRate,
					MaxStartupsFull:                 DefaultSshMaxStartupsFull,
					MaxSessionsPerConnection:        DefaultSshMaxSessionsPerConnection,
					MaxChannelsPerConnection:        DefaultSshMaxChannelsPerConnection,
