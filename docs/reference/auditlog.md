...
Each target requires a unique `name` within its audit log and a `type`. The currently supported target types are `s3`, `sftp`, and `webdav`.
...
#### Properties {: #webdav-properties }

<<property("name", "string", required=True, id_prefix="webdav-", heading=5)>>
The unique, path-safe name of this target within the audit log.

<<property("type", "string", default="webdav", required=True, id_prefix="webdav-", heading=5)>>
...
<<property("endpoint", "URL", "data-type.md#url", required=True, id_prefix="webdav-", heading=5)>>
...
<<property("username", "string", default="", id_prefix="webdav-", heading=5)>>
...
<<property("password", "string", default="", id_prefix="webdav-", heading=5)>>
...
#### Properties {: #sftp-properties }

<<property("name", "string", required=True, id_prefix="sftp-", heading=5)>>
The unique, path-safe name of this target within the audit log.

<<property("type", "string", default="sftp", required=True, id_prefix="sftp-", heading=5)>>
Selects the SFTP target implementation. Type names are case-insensitive when read; Bifröst writes the canonical value `sftp`.

<<property("address", "string", required=True, id_prefix="sftp-", heading=5)>>
The SSH server as `host`, `host:port`, or `[IPv6-address]:port`. An omitted port defaults to `22`.

<<property("user", "string", required=True, id_prefix="sftp-", heading=5)>>
...
<<property("directory", "string", required=True, id_prefix="sftp-", heading=5)>>
...
<<property("knownHosts", "string", id_prefix="sftp-", heading=5)>>
Inline OpenSSH `known_hosts` entries used to verify the server host key.

<<property("knownHostsFile", "File Path", "data-type.md#file-path", id_prefix="sftp-", heading=5)>>
...
<<property("acceptAllHostKeys", "bool", default=False, id_prefix="sftp-", heading=5)>>
...
<<property("identityFiles", "list of File Paths", id_prefix="sftp-", heading=5)>>
...
<<property("password", "string", default="", id_prefix="sftp-", heading=5)>>
...
<<property("connectTimeout", "duration", default="10s", id_prefix="sftp-", heading=5)>>
